...
INSERT INTO mantis_user_table(username, realname, email, password, date_created, last_visit, enabled, protected, access_level, login_count, lost_password_request_count, failed_login_count, cookie_string) VALUES
        ('administrator', '', 'root@localhost', '63a9f0ea7bb98050796b649e85481845', '2015-07-02 23:11:14', '2015-07-02 23:11:14', '1', '0', 90, 3, 0, 0, '2921a49b20cf5e2383be461cee270922e5aa4048c26ebda5224866d65b71f52a');
...
ALTER TABLE mantis_project_table DROP INDEX idx_project_id;

ALTER TABLE mantis_config_table DROP INDEX idx_config;
...
ALTER TABLE mantis_bug_revision_table DROP INDEX idx_bug_rev_id_time;
...
ALTER TABLE mantis_email_table DROP INDEX idx_email_id;
